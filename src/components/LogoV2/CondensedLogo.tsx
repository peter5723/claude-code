...
export function CondensedLogo(): ReactNode {
  ...
  // Truncate version to fit within available width, accounting for "CCB v" prefix
  const versionPrefix = 'CCB v';
    ...
    <OffscreenFreeze>
      <Box flexDirection="row" gap={2} alignItems="center">
        ...
        <Box flexDirection="column">
          <Text>
            <Text bold>CCB</Text> <Text dimColor>v{truncatedVersion}</Text>
          </Text>
          {shouldSplit ? (
            <>
