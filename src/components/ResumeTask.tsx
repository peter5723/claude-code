    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Box flexDirection="row">
          <Spinner />
          <Text bold>Loading CCB sessions…</Text>
        </Box>
        <Text dimColor>{retrying ? 'Retrying…' : 'Fetching your CCB sessions…'}</Text>
      </Box>
    );
  }
    ...
    case 'other':
      return (
        <Box marginY={1} flexDirection="row">
          <Text dimColor>Sorry, CCB encountered an error</Text>
        </Box>
      );
  }
}
