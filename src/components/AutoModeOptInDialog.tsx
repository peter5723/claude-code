...
export const AUTO_MODE_DESCRIPTION =
  "Auto mode lets CCB handle permission prompts automatically — CCB checks each tool call for risky actions and prompt injection before executing. Actions CCB identifies as safe are executed, while actions CCB identifies as risky are blocked and CCB may try a different approach. Ideal for long-running tasks. Sessions are slightly more expensive. CCB can make mistakes that allow harmful commands to run, it's recommended to only use in isolated environments. Shift+Tab to change mode.";
